    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сборы в в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('genres', models.ManyToManyField(to='movies.genres', verbose_name='Жанр')),
            ],
            options={
                'verbose_name': 'Фильмы',
